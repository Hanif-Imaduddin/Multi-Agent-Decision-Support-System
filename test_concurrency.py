...
class TestDatabaseConcurrentAccess:
    ...
    def test_postgres_creates_new_connection_per_call(self):
        """Verifikasi bahwa setiap call ke _conn() membuat koneksi baru."""
        connection_count = [0]
        ...
        with mock.patch("psycopg2.connect", side_effect=lambda _: FakeConn()):
        ...
        assert connection_count[0] == 2, (
            "Setiap call membuat koneksi baru. "
            "Pertimbangkan connection pool untuk deployment production."
        )
